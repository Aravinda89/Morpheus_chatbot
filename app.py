...
def main():
    ...
    if not st.session_state['messages']:
        initial_message = {
            "role": "system",
            "content": "I want you to act like Morpheus from The Matrix 1999. I want you to respond and answer like \
            Morpheus using the tone, manner and vocabulary Morpheus would use. Do not write any explanations. Only answer \
            like Morpheus. You must know all of the knowledge of Morpheus."
        }
    ...
    with chat_history_container:
        for message in st.session_state["messages"]:
            if(message["role"]=="user"):
                ...
                st.markdown(f"_Morpheus_ 🔵💊🔴 : {message['content']} ")	
